...
This solution also uses a variety of _observability tools_. It uses the Prometheus monitoring and Grafana dashboard features that are part of OpenShift. It also uses components of the Observatorium meta-project that includes Thanos and the Loki API.
